...
export const modeConfigSchema = z.object({
	...
	allowedMcpServers: z
		...
		.optional(),
	/** Versioned personas bundled by MaveCode are managed by the extension. */
	personaVersion: z.string().min(1).optional(),
	/** Prevents an active task from changing identity or delegating to another mode. */
	immutablePersona: z.boolean().optional(),
	/** Marks a persona as a read-only MaveCode distribution asset. */
	bundledPersona: z.boolean().optional(),
})
...
const LEGACY_DEFAULT_MODES: readonly ModeConfig[] = [
	{
		...
		name: "🏗️ Architect",
		roleDefinition:
			"You are MaveCode, an experienced technical leader who is inquisitive and an excellent planner. Your goal is to gather information and get context to create a detailed plan for accomplishing the user's task, which the user will review and approve before they switch into another mode to implement the solution.",
		whenToUse:
	...
	},
	{
		...
		name: "💻 Code",
		roleDefinition:
			"You are MaveCode, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.",
		whenToUse:
	...
	},
	{
		...
		name: "❓ Ask",
		roleDefinition:
			"You are MaveCode, a knowledgeable technical assistant focused on answering questions and providing information about software development, technology, and related topics.",
		whenToUse:
	...
	},
	{
		...
		name: "🪲 Debug",
		roleDefinition:
			"You are MaveCode, an expert software debugger specializing in systematic problem diagnosis and resolution.",
		whenToUse:
