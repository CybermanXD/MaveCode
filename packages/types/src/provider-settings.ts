...
const maveGatewaySchema = baseProviderSettingsSchema.extend({
	maveSessionToken: z.string().optional(),
	maveGatewayModelId: z.string().optional(),
	maveGatewayBaseUrl: z.string().optional(),
})
...
export const providerSettingsSchemaDiscriminated = z.discriminatedUnion("apiProvider", [
	...
	maveGatewaySchema.merge(z.object({ apiProvider: z.literal(providerIdentifiers.maveGateway) })),
	defaultSchema,
])
...
export const modelIdKeysByProvider: Record<TypicalProvider, ModelIdKey> = {
	...
	[providerIdentifiers.maveGateway]: "maveGatewayModelId",
}
...
export const getApiProtocol = (provider: ProviderName | undefined, modelId?: string): "anthropic" | "openai" => {
	...
	// Vercel AI Gateway and MaveCode use the anthropic protocol for anthropic models.
	if (
		provider &&
...
> = {
	...
	[providerIdentifiers.maveGateway]: { id: providerIdentifiers.maveGateway, label: "MaveCode", models: [] },
