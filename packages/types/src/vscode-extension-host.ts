...
export interface MaveCodeRateLimitsMessage {
	type: "maveCodeRateLimits"
	values?: OpenAiCodexRateLimitInfo
	error?: string
}
...
export interface RequestMaveCodeRateLimitsMessage {
	type: "requestMaveCodeRateLimits"
}
