...
describe("getApiProtocol", () => {
	...
	describe("Gateway providers", () => {
		it("uses the canonical MaveCode identifier for Anthropic model protocol selection", () => {
			expect(getApiProtocol(providerIdentifiers.maveGateway, "anthropic/claude-3-opus")).toBe(
