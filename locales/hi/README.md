<p align="center">
        ...
        <p align="center">
          <em>जल्दी मदद पाएं → <a href="https://discord.gg/VxfP4Vx3gX">Discord जॉइन करें</a> • Async पसंद है? → <a href="https://www.reddit.com/r/MaveCode/">r/MaveCode जॉइन करें</a></em>
        </p>
...
> active development बंद करने के बाद, MaveCode इस project का development
...
> [Reddit](https://www.reddit.com/r/MaveCode), या
> [PR या issue खोलें](https://github.com/MaveCode-Org/MaveCode) पर।
>
> _-MaveCode Team_
...
MaveCode, Roo Code की बनाई नींव पर आगे बढ़ता है और इसे इन सुविधाओं के साथ लगातार विस्तार देता है:
...
- **Connect करने के और तरीके** — MaveCode, Moonshot, Kimi Code, Kenari, Friendli, OpenCode Go और कई अन्य नए व विस्तारित providers।
...
## MaveCode आपके लिए क्या कर सकता है?
...
- **[सुविधा अनुरोध](https://github.com/MaveCode-Org/MaveCode/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** क्या आपके पास कोई विचार है? इसे डेवलपर्स के साथ साझा करें।
...
वीएसकोड में `F5` दबाएं (या **रन** → **डीबगिंग प्रारंभ करें** पर जाएं)। यह MaveCode एक्सटेंशन के साथ एक नई वीएसकोड विंडो खोलेगा।
...
1.  पहले, VSIX पैकेज बनाएं:
    ...
    pnpm vsix
    ```
2.  `bin/` डायरेक्टरी में एक `.vsix` फ़ाइल जनरेट होगी (जैसे, `bin/mave-code-<version>.vsix` )।
...
**MaveCode का आनंद लें!** चाहे आप इसे short leash पर रखें या इसे autonomously घूमने दें, हम यह देखने के लिए उत्साहित हैं कि आप क्या बनाते हैं। अगर आपके पास questions या feature ideas हैं, तो एक [issue](https://github.com/MaveCode-Org/MaveCode/issues) खोलें या एक [discussion](https://github.com/MaveCode-Org/MaveCode/discussions) शुरू करें। Happy coding!
