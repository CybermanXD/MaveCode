...
# MaveCode'a Katkıda Bulunma

MaveCode topluluk tarafından yürütülen bir projedir ve her katkıyı derinden takdir ediyoruz. İşbirliğini kolaylaştırmak için [Önce Sorun Yaklaşımı](#önce-sorun-yaklaşımı) temelinde çalışıyoruz, bu da tüm [Çekme İsteklerinin (PR'ler)](#pull-request-guidelines) önce bir GitHub Sorununa bağlanması gerektiği anlamına gelir. Lütfen bu kılavuzu dikkatlice inceleyin.
...
### 3. MaveCode topluluğuna katıl

- **Discord:** [Discord](https://discord.gg/VxfP4Vx3gX) sunucumuza katıl.
- **Reddit:** [Reddit](https://www.reddit.com/r/MaveCode/) topluluğumuza katıl.
...
- **Mevcut sorunları kontrol edin**: [GitHub Sorunları](https://github.com/MaveCode-Org/MaveCode/issues)nda arama yapın.
- **Bir sorun oluşturun**:
...
- Issue bulmak için [GitHub Issues sayfasına](https://github.com/MaveCode-Org/MaveCode/issues) bak.
- Belgeler için [MaveCode Belgeleri](https://github.com/MaveCode-Org/MaveCode-Docs)ni ziyaret edin.

### Hataları Bildirme

- Önce mevcut raporları kontrol edin.
- Aşağıdakilerle ["Hata Raporu" şablonunu](https://github.com/MaveCode-Org/MaveCode/issues/new/choose) kullanarak yeni bir hata oluşturun:
    - Açık, numaralandırılmış yeniden oluşturma adımları
    - Beklenen vs gerçek sonuç
    - MaveCode sürümü (gerekli); ilgiliyse API sağlayıcısı/modeli
- **Güvenlik sorunları**: [Güvenlik tavsiyeleri](https://github.com/MaveCode-Org/MaveCode/security/advisories/new) aracılığıyla özel olarak bildirin.
...
Katkıda bulunarak, katkılarınızın MaveCode'un lisanslamasıyla tutarlı olan Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursunuz.
