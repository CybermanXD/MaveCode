...
### 3. Bergabunglah dengan Komunitas MaveCode

- **Discord:** Bergabunglah dengan [Discord](https://discord.gg/VxfP4Vx3gX) kami.
- **Reddit:** Bergabunglah dengan [Reddit](https://www.reddit.com/r/MaveCode/) kami.
...
- **Periksa masalah yang ada**: Cari di [Masalah GitHub](https://github.com/MaveCode-Org/MaveCode/issues).
...
- Periksa [halaman GitHub Issues](https://github.com/MaveCode-Org/MaveCode/issues) untuk melihat issues.
- Untuk dokumentasi, kunjungi [Dokumentasi MaveCode](https://github.com/MaveCode-Org/MaveCode-Docs).

### Melaporkan Bug

- Periksa laporan yang ada terlebih dahulu.
- Buat bug baru menggunakan [template "Laporan Bug"](https://github.com/MaveCode-Org/MaveCode/issues/new/choose) dengan:
    - Langkah-langkah reproduksi yang jelas dan bernomor
    - Hasil yang diharapkan vs aktual
    - Versi MaveCode (wajib); penyedia/model API jika relevan
- **Masalah keamanan**: Laporkan secara pribadi melalui [saran keamanan](https://github.com/MaveCode-Org/MaveCode/security/advisories/new).
...
Dengan berkontribusi, Anda setuju bahwa kontribusi Anda akan dilisensikan di bawah Lisensi Apache 2.0, sesuai dengan lisensi MaveCode.
