...
# Contribuir a MaveCode

MaveCode és un projecte impulsat per la comunitat i valorem profundament cada contribució. Per agilitzar la col·laboració, operem sobre una base de [primer la incidència](#enfocament-de-primera-incidència), la qual cosa significa que totes les [sol·licituds d'extracció (PR)](#enviament-duna-sollicitud-dextracció) primer han d'estar enllaçades a una incidència de GitHub. Si us plau, reviseu aquesta guia amb atenció.
...
### 3. Uneix-te a la comunitat de MaveCode

- **Discord:** Uneix-te al nostre [Discord](https://discord.gg/VxfP4Vx3gX).
- **Reddit:** Uneix-te al nostre [Reddit](https://www.reddit.com/r/MaveCode/).
...
- **Comproveu les incidències existents**: cerqueu a [Incidències de GitHub](https://github.com/MaveCode-Org/MaveCode/issues).
...
- Consulta la [pàgina de GitHub Issues](https://github.com/MaveCode-Org/MaveCode/issues) per veure les issues.
- Per a documents, visiteu [Documents de MaveCode](https://github.com/MaveCode-Org/MaveCode-Docs).

### Informar d'errors

- Comproveu primer si hi ha informes existents.
- Creeu un error nou utilitzant la [plantilla "Informe d'error"](https://github.com/MaveCode-Org/MaveCode/issues/new/choose) amb:
    - Passos de reproducció clars i numerats
    - Resultat esperat vs real
    - Versió de MaveCode (obligatori); proveïdor/model d'API si és rellevant
- **Problemes de seguretat**: informeu de manera privada a través d'[avisos de seguretat](https://github.com/MaveCode-Org/MaveCode/security/advisories/new).
...
En contribuir, accepteu que les vostres contribucions es llicenciaran sota la llicència Apache 2.0, d'acord amb la llicència de MaveCode.
