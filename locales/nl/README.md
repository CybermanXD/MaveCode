<p align="center">
        ...
        <p align="center">
          <em>Snel hulp nodig → <a href="https://discord.gg/VxfP4Vx3gX">Word lid van Discord</a> • Liever asynchroon? → <a href="https://www.reddit.com/r/MaveCode/">Word lid van r/MaveCode</a></em>
        </p>
...
> MaveCode zet de ontwikkeling van dit project voort nadat het Roo-team
...
> [Reddit](https://www.reddit.com/r/MaveCode), of
> [open een PR of issue](https://github.com/MaveCode-Org/MaveCode).
>
> _-MaveCode Team_
...
MaveCode bouwt voort op het fundament van Roo Code en breidt dit verder uit met:
...
- **Meer manieren om verbinding te maken** — nieuwe en uitgebreide providers, waaronder MaveCode, Moonshot, Kimi Code, Kenari, Friendli, OpenCode Go en nog veel meer.
...
## Wat kan MaveCode voor JOU doen?
...
MaveCode past zich aan jouw werkwijze aan, niet andersom:
...
- **[Feature Requests](https://github.com/MaveCode-Org/MaveCode/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Heb je een idee? Deel het met de ontwikkelaars.
...
Er zijn verschillende manieren om de MaveCode-extensie uit te voeren:

### Ontwikkelmodus (F5)

Gebruik voor actieve ontwikkeling de ingebouwde foutopsporing van VSCode:

Druk op `F5` (of ga naar **Uitvoeren** → **Foutopsporing starten**) in VSCode. Dit opent een nieuw VSCode-venster waarin de MaveCode-extensie wordt uitgevoerd.
...
1.  Bouw eerst het VSIX-pakket:
    ...
    pnpm vsix
    ```
2.  Een `.vsix`-bestand wordt gegenereerd in de `bin/`-directory (bijv. `bin/mave-code-<version>.vsix`).
...
**Veel plezier met MaveCode!** Of je het nu kort aangelijnd houdt of autonoom laat rondzwerven, we kunnen niet wachten om te zien wat je bouwt. Als je vragen of feature-ideeën hebt, open dan een [issue](https://github.com/MaveCode-Org/MaveCode/issues) of start een [discussion](https://github.com/MaveCode-Org/MaveCode/discussions). Veel codeerplezier!
