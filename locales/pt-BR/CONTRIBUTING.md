...
### 3. Junte-se à comunidade do MaveCode

- **Discord:** Entre no nosso [Discord](https://discord.gg/VxfP4Vx3gX).
- **Reddit:** Entre no nosso [Reddit](https://www.reddit.com/r/MaveCode/).
...
- **Verifique as issues existentes**: Pesquise nas [Issues do GitHub](https://github.com/MaveCode-Org/MaveCode/issues).
...
- Confira a [página de GitHub Issues](https://github.com/MaveCode-Org/MaveCode/issues) para ver as issues.
- Para documentação, visite [Documentação do MaveCode](https://github.com/MaveCode-Org/MaveCode-Docs).

### Relatando bugs

- Verifique primeiro os relatórios existentes.
- Crie um novo bug usando o [modelo "Relatório de bug"](https://github.com/MaveCode-Org/MaveCode/issues/new/choose) com:
    - Passos de reprodução claros e numerados
    - Resultado esperado vs. real
    - Versão do MaveCode (obrigatório); provedor/modelo de IA, se relevante
- **Problemas de segurança**: Relate em particular por meio de [avisos de segurança](https://github.com/MaveCode-Org/MaveCode/security/advisories/new).
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do MaveCode.
