...
# Contribuer à MaveCode

MaveCode est un projet communautaire, et nous apprécions profondément chaque contribution. Pour simplifier la collaboration, nous fonctionnons sur une base [d’abord l’issue](#approche-issue-first), ce qui signifie que toutes les [Pull Requests (PRs)](#soumettre-une-pull-request) doivent d’abord être liées à une Issue GitHub. Veuillez lire attentivement ce guide.
...
### 3. Rejoins la communauté MaveCode

- **Discord :** Rejoins notre [Discord](https://discord.gg/VxfP4Vx3gX).
- **Reddit :** Rejoins notre [Reddit](https://www.reddit.com/r/MaveCode/).
...
- **Vérifiez les issues existantes** : Recherchez dans les [Issues GitHub](https://github.com/MaveCode-Org/MaveCode/issues).
...
- Consulte la [page GitHub Issues](https://github.com/MaveCode-Org/MaveCode/issues) pour voir les issues.
- Pour la documentation, visitez [MaveCode Docs](https://github.com/MaveCode-Org/MaveCode-Docs).

### Signaler des bugs

- Vérifiez d'abord les rapports existants.
- Créez un nouveau bug en utilisant le [modèle "Rapport de bug"](https://github.com/MaveCode-Org/MaveCode/issues/new/choose) avec :
    - Des étapes de reproduction claires et numérotées
    - Résultat attendu vs réel
    - Version de MaveCode (requise) ; fournisseur/modèle d'API si pertinent
- **Problèmes de sécurité** : Signalez-les en privé via les [avis de sécurité](https://github.com/MaveCode-Org/MaveCode/security/advisories/new).
...
En contribuant, vous acceptez que vos contributions soient sous licence Apache 2.0, conformément à la licence de MaveCode.
