<p align="center">
        ...
        <p align="center">
          <em>Besoin d'aide rapidement → <a href="https://discord.gg/VxfP4Vx3gX">Rejoins Discord</a> • Tu préfères l'asynchrone ? → <a href="https://www.reddit.com/r/MaveCode/">Rejoins r/MaveCode</a></em>
        </p>
        ...
        ## Nous sommes MaveCode

> MaveCode poursuit le développement de ce projet après que l'équipe Roo a
...
> [ouvre une PR ou une issue](https://github.com/MaveCode-Org/MaveCode).
>
> _-MaveCode Team_
...
MaveCode s'appuie sur les fondations créées par Roo Code et continue de les enrichir avec :
...
- **Davantage de façons de se connecter** — providers nouveaux et étendus, notamment MaveCode, Moonshot, Kimi Code, Kenari, Friendli, OpenCode Go et bien d'autres.
...
## Que peut faire MaveCode pour VOUS ?
...
MaveCode s'adapte à votre façon de travailler, pas l'inverse :
...
- **[Demandes de fonctionnalités](https://github.com/MaveCode-Org/MaveCode/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Vous avez une idée ? Partagez-la avec les développeurs.
...
Il existe plusieurs façons d'exécuter l'extension MaveCode :

### Mode développement (F5)

Pour un développement actif, utilisez le débogage intégré de VSCode :

Appuyez sur `F5` (ou allez dans **Exécuter** → **Démarrer le débogage**) dans VSCode. Cela ouvrira une nouvelle fenêtre VSCode avec l'extension MaveCode en cours d'exécution.
...
1.  D'abord, compilez le package VSIX :
    ...
    pnpm vsix
    ```
2.  Un fichier `.vsix` sera généré dans le répertoire `bin/` (par exemple, `bin/mave-code-<version>.vsix`).
...
**Profite bien de MaveCode !** Que tu le gardes en laisse courte ou que tu le laisses se déplacer de façon autonome, on a hâte de voir ce que tu vas construire. Si tu as des questions ou des idées de fonctionnalités, ouvre une [issue](https://github.com/MaveCode-Org/MaveCode/issues) ou lance une [discussion](https://github.com/MaveCode-Org/MaveCode/discussions). Bon code !
