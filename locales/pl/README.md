<p align="center">
        ...
        <p align="center">
          <em>Szybko uzyskaj pomoc → <a href="https://discord.gg/VxfP4Vx3gX">Dołącz do Discorda</a> • Wolisz asynchronicznie? → <a href="https://www.reddit.com/r/MaveCode/">Dołącz do r/MaveCode</a></em>
        </p>
...
> MaveCode kontynuuje rozwój tego projektu po tym, jak zespół Roo zakończył
...
> [Reddicie](https://www.reddit.com/r/MaveCode), albo
> [otwórz PR lub issue](https://github.com/MaveCode-Org/MaveCode).
>
> _-MaveCode Team_
...
MaveCode rozwija fundament stworzony przez Roo Code i stale rozszerza go o:
...
- **Więcej sposobów łączenia** — nowych i rozszerzonych providerów, w tym MaveCode, Moonshot, Kimi Code, Kenari, Friendli, OpenCode Go i wielu innych.
...
## Co MaveCode może zrobić dla CIEBIE?
...
MaveCode dostosowuje się do Twojego sposobu pracy, a nie odwrotnie:
...
- **[Prośby o funkcje](https://github.com/MaveCode-Org/MaveCode/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Masz pomysł? Podziel się nim z deweloperami.
...
Istnieje kilka sposobów na uruchomienie rozszerzenia MaveCode:

### Tryb deweloperski (F5)

Do aktywnego programowania użyj wbudowanego debugowania VSCode:

Naciśnij `F5` (lub przejdź do **Uruchom** → **Rozpocznij debugowanie**) w VSCode. Otworzy to nowe okno VSCode z uruchomionym rozszerzeniem MaveCode.
...
1.  Najpierw zbuduj pakiet VSIX:
    ...
    pnpm vsix
    ```
2.  Plik `.vsix` zostanie wygenerowany w katalogu `bin/` (np. `bin/mave-code-<version>.vsix`).
...
**Miłego korzystania z MaveCode!** Niezależnie od tego, czy trzymasz go na krótkiej smyczy, czy pozwalasz mu działać autonomicznie, nie możemy się doczekać, żeby zobaczyć, co zbudujesz. Jeśli masz pytania albo pomysły na funkcje, otwórz [issue](https://github.com/MaveCode-Org/MaveCode/issues) albo rozpocznij [discussion](https://github.com/MaveCode-Org/MaveCode/discussions). Miłego kodowania!
