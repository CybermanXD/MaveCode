<p align="center">
        ...
        <p align="center">
          <em>Hai bisogno di aiuto in fretta → <a href="https://discord.gg/VxfP4Vx3gX">Unisciti a Discord</a> • Preferisci l'asincrono? → <a href="https://www.reddit.com/r/MaveCode/">Unisciti a r/MaveCode</a></em>
        </p>
...
> MaveCode continua lo sviluppo di questo progetto dopo che il team di Roo
...
> [Reddit](https://www.reddit.com/r/MaveCode), oppure
> [apri una PR o una issue](https://github.com/MaveCode-Org/MaveCode).
>
> _-MaveCode Team_
...
MaveCode parte dalle fondamenta create da Roo Code e continua ad ampliarle con:
...
- **Più modi per connettersi** — provider nuovi e ampliati, tra cui MaveCode, Moonshot, Kimi Code, Kenari, Friendli, OpenCode Go e molti altri.
...
MaveCode si adatta al tuo modo di lavorare, non il contrario:
...
- **[Richieste di funzionalità](https://github.com/MaveCode-Org/MaveCode/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Hai un'idea? Condividila con gli sviluppatori.
...
Ci sono diversi modi per eseguire l'estensione MaveCode:

### Modalità di sviluppo (F5)

Per lo sviluppo attivo, usa il debug integrato di VSCode:

Premi `F5` (o vai su **Esegui** → **Avvia debug**) in VSCode. Si aprirà una nuova finestra di VSCode con l'estensione MaveCode in esecuzione.
...
1.  Per prima cosa, compila il pacchetto VSIX:
    ...
    pnpm vsix
    ```
2.  Un file `.vsix` verrà generato nella directory `bin/` (ad es. `bin/mave-code-<version>.vsix`).
...
**Divertiti con MaveCode!** Che tu lo tenga al guinzaglio corto o lo lasci muoversi in autonomia, non vediamo l'ora di vedere cosa costruirai. Se hai domande o idee per nuove funzionalità, apri una [issue](https://github.com/MaveCode-Org/MaveCode/issues) o avvia una [discussion](https://github.com/MaveCode-Org/MaveCode/discussions). Buon coding!
