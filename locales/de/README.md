<p align="center">
        ...
        <p align="center">
          <em>Schnelle Hilfe → <a href="https://discord.gg/VxfP4Vx3gX">Discord beitreten</a> • Lieber asynchron? → <a href="https://www.reddit.com/r/MaveCode/">r/MaveCode beitreten</a></em>
        </p>
...
> MaveCode führt die Entwicklung dieses Projekts fort, nachdem das Roo-Team
...
> [Reddit](https://www.reddit.com/r/MaveCode), oder
> [eröffne eine PR oder ein Issue](https://github.com/MaveCode-Org/MaveCode).
>
> _-MaveCode Team_
...
MaveCode baut auf dem von Roo Code geschaffenen Fundament auf und erweitert es fortlaufend um:
...
- **Mehr Verbindungsmöglichkeiten** — neue und erweiterte Anbieter, darunter MaveCode, Moonshot, Kimi Code, Kenari, Friendli, OpenCode Go und viele mehr.
...
## Was kann MaveCode für DICH tun?
...
MaveCode passt sich an deine Arbeitsweise an, nicht umgekehrt:
...
- **[Feature-Anfragen](https://github.com/MaveCode-Org/MaveCode/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Hast du eine Idee? Teile sie mit den Entwicklern.
...
Es gibt mehrere Möglichkeiten, die MaveCode-Erweiterung auszuführen:

### Entwicklungsmodus (F5)

Für die aktive Entwicklung verwende das integrierte Debugging von VSCode:

Drücke `F5` (oder gehe zu **Ausführen** → **Debuggen starten**) in VSCode. Dies öffnet ein neues VSCode-Fenster mit der laufenden MaveCode-Erweiterung.
...
1.  Erstelle zuerst das VSIX-Paket:
    ...
    pnpm vsix
    ```
2.  Eine `.vsix`-Datei wird im `bin/`-Verzeichnis generiert (z. B. `bin/mave-code-<version>.vsix`).
...
**Viel Spaß mit MaveCode!** Egal, ob du ihn an der kurzen Leine hältst oder autonom losziehen lässt, wir freuen uns darauf zu sehen, was du baust. Wenn du Fragen oder Ideen für Funktionen hast, eröffne ein [Issue](https://github.com/MaveCode-Org/MaveCode/issues) oder starte eine [Diskussion](https://github.com/MaveCode-Org/MaveCode/discussions). Viel Spaß beim Coden!
