...
const getWelcomeApiConfiguration = (
	...
	const validationError = validateApiConfiguration(apiConfiguration, undefined, undefined, maveCodeIsAuthenticated)
	if (validationError) {
		return DEFAULT_WELCOME_API_CONFIGURATION
	}
...
const WelcomeViewProvider = () => {
	const { apiConfiguration, currentApiConfigName, setApiConfiguration, uriScheme, maveCodeIsAuthenticated } =
		useExtensionState()
	...
	const effectiveApiConfiguration =
		welcomeApiConfiguration ?? getWelcomeApiConfiguration(apiConfiguration, maveCodeIsAuthenticated)
	...
	const handleGetStarted = useCallback(() => {
		if (!showProviderSetup) {
			const initialApiConfiguration = getWelcomeApiConfiguration(apiConfiguration, maveCodeIsAuthenticated)
		...
		const error = validateApiConfiguration(effectiveApiConfiguration, undefined, undefined, maveCodeIsAuthenticated)
