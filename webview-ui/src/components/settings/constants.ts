...
export const PROVIDERS: Array<{ value: string; label: string; proxy: boolean }> = [
	{ value: providerIdentifiers.maveGateway, label: "MaveCode", proxy: false },
	...
	if (a.value === providerIdentifiers.maveGateway) return -1
	if (b.value === providerIdentifiers.maveGateway) return 1
