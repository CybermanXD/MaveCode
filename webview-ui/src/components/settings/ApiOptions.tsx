...
import { useMaveGatewayRouterModelsSync } from "@src/components/ui/hooks/useMaveGatewayRouterModelsSync"
...
const ApiOptions = ({
	...
	useMaveGatewayRouterModelsSync()
	...
	useEffect(() => {
		...
		// MaveCode renders its own auth-state error inline (sign-in card in
		// MaveGateway.tsx) so it can react to maveCodeIsAuthenticated changes
		...
		<div className="flex flex-col gap-3">
			...
			{isRetiredSelectedProvider ? (
				...
				<>
					...
					{selectedProvider === providerIdentifiers.maveGateway && (
						<MaveGateway
							apiConfiguration={apiConfiguration}
							setApiConfigurationField={setApiConfigurationField}
							routerModels={routerModels}
