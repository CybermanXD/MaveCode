...
vi.mock("@src/components/ui/hooks/useMaveGatewayRouterModelsSync", () => ({
	useMaveGatewayRouterModelsSync: vi.fn(),
}))
...
vi.mock("../providers", () => {
	...
	return {
		...
		MaveGateway: provider("provider-mave-gateway"),
...
describe("ApiOptions interactions", () => {
	...
	it("clears parent validation errors for MaveCode", () => {
		const setErrorMessage = vi.fn()
		renderApiOptions({ apiConfiguration: { apiProvider: providerIdentifiers.maveGateway }, setErrorMessage })
