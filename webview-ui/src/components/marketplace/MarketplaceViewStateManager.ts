 ...
 *
 * This class manages the state for the marketplace view in the MaveCode extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the MaveCode extensions interface
