...
export const ChatTextArea = forwardRef<HTMLTextAreaElement, ChatTextAreaProps>(
	(
		...
		const activeModeConfig = customModes?.find(({ slug }) => slug === mode)
		const personaLockedForTask = activeModeConfig?.immutablePersona === true && clineMessages.length > 0
