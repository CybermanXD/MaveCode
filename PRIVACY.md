# MaveCode Privacy Policy

**Last Updated: May 13th, 2026**

MaveCode respects your privacy and is committed to transparency about how we
handle your data. Below is a simple breakdown of where key pieces of data
go—and, importantly, where they don't.

## **Where Your Data Goes (And Where It Doesn’t)**

- **Code & Files**: MaveCode accesses files on your local machine when needed
  for AI-assisted features. When you send commands to MaveCode, relevant files
  may be transmitted to your chosen AI model provider (e.g., OpenAI, Anthropic,
  OpenRouter) to generate responses. If you select MaveCode Cloud as the model
  provider (proxy mode), your code may transit MaveCode servers only to forward
...
- **Commands**: Any commands executed through MaveCode happen on your local
...
- **Prompts & AI Requests**: When you use AI-powered features, your prompts and
  ...
  store data per their terms of service. If you choose MaveCode Cloud as the
  provider (proxy mode), prompts may transit MaveCode servers only to forward
...
- **Telemetry (Usage Data)**: We collect feature usage and error data to help
  us improve MaveCode. This telemetry is powered by PostHog and includes your
...
- **Marketplace Requests**: When you browse or search the Marketplace for Model
  Configuration Profiles (MCPs) or Custom Modes, MaveCode makes a secure API
  call to MaveCode's backend servers to retrieve listing information. These
...
- We use telemetry to understand feature usage and improve MaveCode.
...
- Telemetry collection is enabled by default to help us improve MaveCode, but
  you can opt out at any time through the settings.
- You can delete MaveCode to stop all data collection.
...
For any privacy-related questions, reach out to us at support@mavecode.dev.

---

By using MaveCode, you agree to this Privacy Policy.
