...
export class TerminalProcess extends BaseTerminalProcess {
	...
	public override async run(command: string) {
		...
		// PS-specific counter/sleep workarounds.  Prefer the MaveCode profile
	...
	private prepareCommandForShellIntegration(
		...
		//
		// Try the MaveCode profile first; if unset, fall back to the VS Code default
		// profile so users who haven't configured a MaveCode profile override still
