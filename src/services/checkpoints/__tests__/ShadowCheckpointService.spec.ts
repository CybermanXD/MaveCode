...
const initWorkspaceRepo = async ({
	workspaceDir,
	userName = "MaveCode",
	userEmail = "support@mavecode.invalid",
	...
	(klass, prefix) => {
		...
		describe(`${klass.name}#hasNestedGitRepositories`, () => {
			it("throws error when nested git repositories are detected during initialization", async () => {
				...
				await mainGit.init()
				await mainGit.addConfig("user.name", "MaveCode")
				await mainGit.addConfig("user.email", "support@mavecode.invalid")
				...
				await nestedGit.addConfig("user.name", "MaveCode")
				await nestedGit.addConfig("user.email", "support@mavecode.invalid")
