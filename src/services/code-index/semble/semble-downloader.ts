 ...
 * Maps to archive names at https://github.com/MaveCode-Org/sembleexec/releases
 *
...
const DOWNLOAD_BASE_URL = `https://github.com/MaveCode-Org/sembleexec/releases/download/${SEMBLE_VERSION}`
