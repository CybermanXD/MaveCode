...
vi.mock("../../cloud/CloudCompatibility", () => ({
	CloudService: {
		hasInstance: vi.fn(),
		instance: {
	...
	PRODUCTION_CLERK_BASE_URL: "https://identity.mavecode.invalid",
}))
...
import { CloudService, getClerkBaseUrl, PRODUCTION_CLERK_BASE_URL } from "../../cloud/CloudCompatibility"
...
describe("MdmService", () => {
	...
	beforeEach(() => {
		...
		mockGetClerkBaseUrl.mockReturnValue("https://identity-dev.mavecode.invalid")
